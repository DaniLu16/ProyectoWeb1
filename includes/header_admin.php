...
<body>
  ...
  <ul class="nav nav-tabs" id="navId">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/administrador/adm_friends">Ver Árboles por Amigos</a>
        <a class="dropdown-item" href="/administrador/adm_friends">Administar Árboles de Amigos </a>
